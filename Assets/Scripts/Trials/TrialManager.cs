...
public class TrialManager : MonoBehaviour
{
    ...
    public Configurable<int> skyColor = new Configurable<int>();
    ...
    internal void Refresh()
    {
        ...
        // Refresh UI camera distance and sky color
    ...
    internal IEnumerator StartTrial(TestCase.TrialType type)
    {
        ...
        // Run custom code before countdown
        ball.BeforeCountdown();
